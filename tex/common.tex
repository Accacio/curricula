...
\newline\ml{Team}{Time}{Équipe}: Commande --- LS2N}%
...
{}
{
  \begin{itemize}
    ...
    \item SA UE Electrical Engineering (Régulation Thermique) L3 SA  (10h)
...
\cvlistitem{\ml{Reviewer for the}{Revisor para}{Reviewer pour} European Control Conference 2024/2025}
\cvlistitem{\ml{Reviewer for the}{Revisor para}{Reviewer pour} Asian Journal of Control 2024/2025}
\section{
  \ml
  {Programs}
  {Programas}
...
\cvlistdoubleitem{
  ...
  {Sécurité de Syst. Cyberphysiques}
}
{
  % \ml
  % {}
